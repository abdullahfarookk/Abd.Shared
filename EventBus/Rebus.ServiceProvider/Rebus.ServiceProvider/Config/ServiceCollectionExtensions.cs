...
public static class ServiceCollectionExtensions
{
    ...
    /// Registers the given <typeparamref name="THandler"/> with a transient lifestyle
    /// </summary>
    public static IServiceCollection AddRebusHandler<THandler>(this IServiceCollection services, Func<IServiceProvider, THandler> factory) where THandler : IEventHandler
    {
        if (services == null) throw new ArgumentNullException(nameof(services));
